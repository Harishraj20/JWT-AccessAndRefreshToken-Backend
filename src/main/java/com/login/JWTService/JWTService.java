...
public class JWTService {
    ...
    private final long ACCESS_DURATION = 1000 * 60 * 15;
    private final long REFRESH_DURATION = 1000 * 60 * 30;
    ...
    public int getAccessTokenDuration(){
        return (int) (ACCESS_DURATION/1000);
    }
    public int  getRefreshTokenDuration(){
        return (int) (REFRESH_DURATION/1000);
    }
    ...
    private Claims extractAllClaims(String token) {
        logger.info("Secret Key for extractAllClaims: {}", secretKey);
